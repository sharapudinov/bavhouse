        ...
        [
            ...
            "CACHE" => [
                "TAG"   => CCache::GetIBlockCacheTag(
                    CCache::$arIBlocks[ SITE_ID ]["aspro_allcorp_content"]["aspro_allcorp_projects"][0]
                ),
                "MULTI" => "Y"
            ]
        ],
        [
            "IBLOCK_ID"     => CCache::$arIBlocks[ SITE_ID ]["aspro_allcorp_content"]["aspro_allcorp_projects"][0],
            "ACTIVE"        => "Y",
            "GLOBAL_ACTIVE" => "Y",
            "ACTIVE_DATE"   => "Y"
        ]
