		...
		<div class="group-content">
			...
			<?if($arParams["VIEW_TYPE"] == "table"):?>
				...
				$(document).ready(function(){
					setTimeout(function(){
						$(".table." + templateName + " .row .item:visible .image").sliceHeight({slice: <?=$arParams["COUNT_IN_LINE"]?>, lineheight:-3});
						$(".table." + templateName + " .row .item:visible .text").sliceHeight({slice: <?=$arParams["COUNT_IN_LINE"]?>});
					}, 500);
				})
				</script>
			<?endif;?>
