...
$arSubsectionFilter = $arSectionFilter;
...
$arSubSections = CCache::CIblockSection_GetList(array("CACHE" => array("TAG" => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "Y")), array_merge($arSubsectionFilter, array("SECTION_ID" => $arSection["ID"])), false, array("ID"));
?>
<?if(!$arSection):?>
