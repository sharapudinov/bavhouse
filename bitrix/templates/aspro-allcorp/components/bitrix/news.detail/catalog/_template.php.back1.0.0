				...
				<?if($arResult["PROPERTIES"]["FORM_ORDER"]["VALUE_XML_ID"]=="YES" || $arResult["PROPERTIES"]["FORM_QUESTION"]["VALUE_XML_ID"]=="YES"){?>
					<div class="order">
						<?if($arResult["PROPERTIES"]["FORM_ORDER"]["VALUE_XML_ID"]=="YES"){?>
							<span class="btn btn-primary btn-sm" data-event="jqm" data-param-id="18" data-name="order_product" data-product="<?=$arResult["NAME"]?>"><?=GetMessage("TO_ORDER")?></span>
							<br/>
						<?}?>
						<?if($arResult["PROPERTIES"]["FORM_QUESTION"]["VALUE_XML_ID"]=="YES"){?>
							<span class="btn btn-default btn-sm" data-event="jqm" data-param-id="21" data-name="question" data-product="<?=$arResult["NAME"]?>"><?=GetMessage("TO_CALL")?></span>
						<?}?>
		...
		<div class="styled-block catalog">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-5 valign">
					<span class="btn btn-primary btn-sm" data-event="jqm" data-param-id="21" data-param-captcha="yes" data-name="question" data-product="<?=$arResult["NAME"]?>"><span><?=GetMessage("TO_CALL")?></span></span>
				</div>
