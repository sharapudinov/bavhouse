...
$APPLICATION->SetTitle("Поиск");?><?$APPLICATION->IncludeComponent("bitrix:search.page", "search", Array(
	...
	"arrFILTER_iblock_aspro_allcorp_catalog" => array(	// Искать в информационных блоках типа "iblock_aspro_catalog"
		0 => "all",
	),
	"arrFILTER_iblock_aspro_allcorp_content" => array(	// Искать в информационных блоках типа "iblock_aspro_content"
		0 => "all",
	),
